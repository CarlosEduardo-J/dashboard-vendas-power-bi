...
Este projeto apresenta uma **análise de vendas e lucratividade**, desenvolvida no **Power BI**, utilizando a base de dados **SuperStore**, amplamente utilizada em estudos e projetos de **Análise de Dados**.

O objetivo do dashboard é transformar dados brutos em **informações visuais claras e objetivas**, facilitando a leitura de indicadores financeiros e o entendimento do desempenho do negócio ao longo do tempo.
...
- Desenvolver um dashboard com **padrão profissional para portfólio**
...
Esses KPIs permitem uma visão rápida e objetiva da **saúde financeira do negócio**.

---

## 📐 Medidas Criadas (DAX)

As principais medidas desenvolvidas no projeto foram:
